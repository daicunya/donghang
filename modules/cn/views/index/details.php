      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="details.html">表格</a></li>
            <li><a href="details.html">文件</a></li>
            <li><a href="#">打码印刷</a></li>
            <li><a href="#">笔记本</a></li>
            <li><a href="#">无碳复写三联单</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
          ...
          <div class="dropdown-menu nav-second clearfix">
            ...
            <ul>
              ...
              <li><a href="">塑料薄膜</a></li>
              <li><a href="">快递袋</a></li>
              <li><a href="">利乐包(牛奶包)</a></li>
              <li><a href="">无纺布</a></li>
              <li><a href="">纸塑复合材料</a></li>
            </ul>
          </div>
        </li>
        <li class="dropdown">
...
<div class="container">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">牛奶包(利乐包)</li>
  </ol>
  <div class="detail-wrap clearfix">
    <section class="detail-cnt col-md-8 col-sm-12 col-xs-12">
      <div class="detail-img">
        <img src="/cn/images/details01.jpg" alt="">
        <img src="/cn/images/details02.jpg" alt="">
        <img src="/cn/images/details03.jpg" alt="">
        <img src="/cn/images/details04.jpg" alt="">
        <img src="/cn/images/details05.jpg" alt="">
        <img src="/cn/images/details06.jpg" alt="">
      </div>
    </section>
...
<footer class="footer">
  ...
  <div class="pc-wrap">
    <div class="container">
      <div class="box clearfix">
        ...
        <ul>
          <h5>图文输出</h5>
          <li><a href="">打印装订标书、</a><a href="">精装册</a></li>
          <li><a href="">喷绘、</a><a href="">写真、</a><a href="">条幅</a></li>
          <li><a href="">工程复印、</a><a href="">彩图输出</a></li>
          <li><a href="">数码蓝图</a></li>
          <li><a href="">设计名片</a></li>
          <li><a href="">宣传页</a></li>
          <li><a href="">画册</a></li>
        ...
        <div class="col-md-5">
          ...
          <p><i class="fa fa-phone"></i>200-32-100</p>
        </div>
      </div>
      <ul class="web-description">
        <li><a href="about.html#aboutUS">关于我们</a></li>
        <li><a href="about.html#contactUS">联系我们</a></li>
  ...
  <!--移动端-->
  <div class="phone-wrap container">
    <div class="ewm">
      <img src="/cn/images/ewm.jpg" alt="二维码">
      <p>关注我们</p>
    </div>
    <div class="phone">
      <a href="">400-123-333</a>
    </div>
    <p> Copyright © 2018  donghang.com    版权所有   <br/>
      鲁ICP备14013361号-7</p>
  </div>
</footer>
